...
router.register(r"pay-grade", org_api.PayGradeViewSet, "pay-grade")
router.register(r"pay-grade-step", org_api.PayGradeStepViewSet, "pay-grade-step")
router.register(r"surcharge-rate", org_api.SurchargeRateViewSet, "surcharge-rate")
